...
turno =["Dia 1","Dia 2","Dia 3","Dia 4","Free"]
...
text_dia=f"Dia {dia_ingresado} {mes_ingresado} inicia en: "
ET_LAB =Label(FRAME,text=text_dia) 
ET_LAB.grid(row=row,column=col,columnspan=3,sticky="w")

row=4

for var_row in range(0,5):
    range_dow=f"{var_row}) {turno[var_row]}"
